...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        .addField("<:Add:728113829719834695> Invite Aura", "[Invite](https://discord.com/oauth2/authorize?client_id=714286777388499054&scope=bot&permissions=2113391862) Aura" )
