...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        .addField("<:Add:728113829719834695> Invite Aura", "[Invite](https://discordapp.com/oauth2/authorize?client_id=714286777388499054&scope=bot&permissions=2146958847) Aura" )
        .addField("<:Info:728113829376032849> Support Server", "[discord.gg/zA4A3xN](https://discord.gg/zA4A3xN)" )
        .addField("<:Website:728113830005309500> Auras Websites", "Find Auras websites at [aurabot.xyz](https://aurabot.xyz)" )
