...
module.exports.run = async (bot, message, args) => {
    if(message.content === "-help-Reaction ") {
            var helpReaction = new Discord.MessageEmbed()
            ...
            .setDescription('Reaction Rolen\'s Are Comming Soon.... Stay Tune!') 
            ...
            message.channel.send(helpReaction);
            console.error() }
        }


module.exports.config = {
command: "helpreaction"
}